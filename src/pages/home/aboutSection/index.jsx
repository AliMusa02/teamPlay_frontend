      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        <div className="w-full lg:w-1/2 text-white space-y-6 text-center lg:text-left">
          <h2 className="text-3xl md:text-4xl font-bold text-yellow-400">
            About <span className="text-cyan-400">AliTeam</span>
          </h2>
          <p className="text-white/80 text-lg leading-relaxed">
            AliTeam is a platform where football lovers can build their dream
            ...
            casual player or a future champion, AliTeam is for you!
          </p>
        </div>
        {/* Şəkil tərəfi */}
